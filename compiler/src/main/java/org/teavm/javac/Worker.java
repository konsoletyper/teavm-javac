...
public final class Worker {
    ...
    private void compileAll(CompileMessage request) throws IOException {
        ...
        if (doCompile(request) && detectMainClass(request) && generateWebAssembly(request)) {
    ...
    private void handleDiagnostic(JavaDiagnostic diagnostic, String requestId) {
        ...
        response.setLineNumber(diagnostic.getColumnNumber());
    ...
    private boolean generateWebAssembly(WorkerMessage request) {
        ...
        return compiler.generateWebAssembly(options);
    }
